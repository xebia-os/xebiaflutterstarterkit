...
import 'package:xiflutter/dynamic_widget/drop_cap_text.dart';
...
BorderRadius parseBorderRadius(dynamic borderRadius) {
  //left,top,right,bottom
...
setThemeColor(BuildContext context, String themeColor) {
  if (themeColor == null) {
    return null;
  } else if (themeColor == 'primaryColor') {
    return Theme.of(context).primaryColor;
  } else if (themeColor == 'accentColor') {
    return Theme.of(context).accentColor;
  } else if (themeColor == 'transparent') {
