...
class MaterialButtonScreen extends StatefulWidget {

  @override
  _MaterialButtonScreenState createState() => _MaterialButtonScreenState();
}

class _MaterialButtonScreenState extends State<MaterialButtonScreen> {
  @override
  void initState() {
    super.initState();
  }
